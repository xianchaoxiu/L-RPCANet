...
class Trainer(object):
    def __init__(self, args):
        ...
        if args.dataset == 'sirstaug':
            ...
            trainset = NUDTDataset(base_dir=r'./datasets/NUDT-SIRST', mode='train', base_size=args.base_size) # base_dir=r'E:\ztf\datasets\NUDT-MIRSDT'
            valset = NUDTDataset(base_dir=r'./datasets/NUDT-SIRST', mode='test', base_size=args.base_size) # base_dir=r'E:\ztf\datasets\NUDT-MIRSDT'
        else:
